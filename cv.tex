...
\item Led a pilot project evaluating LLMs for medical information extraction.  \hfill Germany, Remote\\
Including Prompt Engineering, LangChain Development, Finetuning
...
(SDN, System Engineering, Internet Infrastructure, Unix/Linux, Big Data, Pandas, Elastic, Kafka) \\
\end{itemize}
...
\setlength\itemsep{0.05em}
    ...
    (Java, Python, Java Spring, PyTorch) \\
\end{itemize}
...
{\bf Misc }(\textit{cli-apps, chat-bots, requirements engineering, web-scraping}) \\\\
%\noindent
