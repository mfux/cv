...
\item Led a pilot project evaluating large language models (LLMs) for medical information extraction. Including Prompt Engineering, LangChain Development, Finetuning LLMs, and Evaluating and Debugging AI Models) \hfill Germany, Remote 
